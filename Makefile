...
multirun:
	(cd src/;ln -sf ../${target}/${MODEL}.h model.h; ln -sf models/${MODEL}.cpp model.cpp; ln -sf ../input.h .; make; mv ode.exe ../${target}; \
		echo "The executable file has been moved to ${target}.")
