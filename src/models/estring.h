...
using namespace std;
/* ----------------------------------------*/
unsigned int const Np=1001;			// total number of points on the rod.
unsigned int const pdim=3*Np;
double const height = 10;					// height of the box we are doing simulations in.
...
double const dd = 0.0005*(double)height; 	// r/l ratio for the rod has been kept constant. It should be noted that the particles would also have same diameter. 
...
/* ----------------------------------------*/
void iniconf(double *y, double *vel, int conf_number); 	// The configuration number is defined for different
