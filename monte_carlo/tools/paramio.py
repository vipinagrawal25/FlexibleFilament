...
def write_param(fname="../para_file.in",paramdict=None):
	...
	with open(fname, "w") as file:
		...
		file.write("N coef_bending Y coef_vol_expansion pressure radius\n")
		file.write("%d %3.2f %3.2f %3.2f %3.2f %3.2f\n" %(paramdict['N'],paramdict['coef_bending'],
					paramdict['Y'],paramdict['coef_vol_expansion'],paramdict['pressure'],paramdict['radius']))
